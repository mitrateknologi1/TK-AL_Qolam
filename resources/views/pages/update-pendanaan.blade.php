                ...
                <div class="row">
                    ...
                    <div class="multisteps-form">
                        ...
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" method="POST" action="{{ url('update-pendanaan/'.$getpendanaan) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <select class="form-control" name="pemasukan_ortu">
                                            <?php $kategori = ['< Rp. 1.000.000,00','Rp. 1.000.000,00 - Rp. 3.000.000,00','Rp. 3.000.000,00'] ?>
                                            @foreach($kategori as $kat)
                                            <option value="{{$kat}}" {{ $get->pendanaan->pemasukan_ortu == $kat ? 'selected':'' }}>{{$kat}}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                        <div class="row mt-3">
                                        ...
                                        <textarea class="multisteps-form__input form-control" name="kenaikan_konsumsi" rows="5" cols="5" > {{ $get->pendanaan->kenaikan_konsumsi }}</textarea>
                                        </div>  
                                        ...
                                        <textarea class="multisteps-form__input form-control" name="infaq" rows="5" cols="5" > {{ $get->pendanaan->infaq }}</textarea>
                                        </div>
                                        </div>
