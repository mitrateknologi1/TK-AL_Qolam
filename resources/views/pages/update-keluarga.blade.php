                ...
                <div class="row">
                    ...
                    <div class="multisteps-form">
                        ...
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" method="POST" action="{{ url('update-keluarga/'.$getkeluarga) }}">
                                @csrf
                                @method('PUT')
                                    <!--single form panel-->
                                    ...
                                    <h6 class="font-weight-bolder">Ayah</h6>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->nama_lengkap }}" name="nama_ayah" type="text" placeholder="eg. Off-White"  required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Tanggal Lahir</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->tanggal_lahir }}"  name="tanggal_lahir_ayah" type="date" placeholder=" 7 Juli 1980" required />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6">
                                          <label>Tempat Lahir</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->tempat_lahir }}" name="tempat_lahir_ayah" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            ...
                                            <option value="{{$p}}" {{ $get->keluarga->ayah->pekerjaan == $p ? 'selected':'' }} >{{$p}}</option>
                                            @endforeach
                                          </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <option selected="selected">--Pilih Agama--</option>
                                           @foreach($agama as $a)
                                          <option value="{{$a}}" {{ $get->keluarga->ayah->agama == $a ? 'selected':'' }}>{{$a}}</option>
                                          @endforeach
                                          </select>
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          ...
                                          <option value="{{$pe}}" {{ $get->keluarga->ayah->pendidikan == $pe ? 'selected':'' }}>{{$pe}}</option>
                                          @endforeach
                                          </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->alamat }}" name="alamat_ayah" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Alamat Kantor</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->alamat_kantor }}" name="alamat_kantor_ayah" type="text" placeholder="no telepon" required />
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Rumah</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->nomor_telepon_rumah }}" name="nomor_telepon_rumah_ayah" type="text"  placeholder="no telepon" required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Kantor</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->nomor_telepon_kantor }}" name="nomor_telepon_kantor_ayah" type="text"  placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor WhatsApp</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ayah->no_whatsapp }}" name="no_whatsapp_ayah" type="text"  placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <p></p>
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          <label>Nama lengkap</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->nama_lengkap }}" name="nama_ibu" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Tanggal Lahir</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->tanggal_lahir }}" name="tanggal_lahir_ibu" type="date" placeholder="Palu, 7 Juli 1980" required />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6">
                                          <label>Tempat Lahir</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->tempat_lahir }}" name="tempat_lahir_ibu" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Pekerjaan</label>
                                            <?php 
                                            ...
                                            <option value="{{$p}}" {{ $get->keluarga->ibu->pekerjaan == $p ? 'selected':'' }}>{{$p}}</option>
                                            @endforeach
                                          </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <option selected="selected">--Pilih Agama--</option>
                                           @foreach($agama as $a)
                                          <option value="{{$a}}" {{ $get->keluarga->ibu->agama == $a ? 'selected':'' }}>{{$a}}</option>
                                          @endforeach
                                          </select>
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          ...
                                          <option selected="selected">--Pilih Pendidikan--</option>
                                           @foreach($pendidikan as $pe)
                                          <option value="{{$pe}}" {{ $get->keluarga->ibu->pendidikan == $pe ? 'selected':'' }}>{{$pe}}</option>
                                          @endforeach
                                          </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          <label>Alamat Rumah</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->alamat }}" name="alamat_ibu" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Alamat Kantor</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->alamat_kantor }}" name="alamat_kantor_ibu" type="text" placeholder="no telepon" required />
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Rumah</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->nomor_telepon_rumah }}"  name="nomor_telepon_rumah_ibu" type="text" placeholder="no telepon" required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Kantor</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->nomor_telepon_kantor }}" name="nomor_telepon_kantor_ibu" type="text" placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor Whatsapp</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->ibu->no_whatsapp }}" name="no_whatsapp_ibu" type="text" placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <p></p>
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          <label>Nama lengkap</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->nama_lengkap }}" name="nama_wali" type="text" placeholder="eg. Off-White"  />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Tanggal Lahir</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->tanggal_lahir }}" name="tanggal_lahir_wali" type="date" placeholder="Palu, 7 Juli 1980"  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6">
                                          <label>Tempat Lahir</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->tempat_lahir }}" name="tempat_lahir_wali" type="text" placeholder="eg. Off-White"  />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Pekerjaan</label>
                                            <?php 
                                            ...
                                            <option value="{{$p}}" {{ $get->keluarga->wali->pekerjaan == $p ? 'selected':'' }}>{{$p}}</option>
                                            @endforeach
                                          </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <option selected="selected">--Pilih Agama--</option>
                                           @foreach($agama as $a)
                                          <option value="{{$a}}" {{ $get->keluarga->wali->agama == $a ? 'selected':'' }}>{{$a}}</option>
                                          @endforeach
                                          </select>
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          ...
                                          <option selected="selected">--Pilih Pendidikan--</option>
                                           @foreach($pendidikan as $pe)
                                          <option value="{{$pe}}" {{ $get->keluarga->wali->pendidikan == $pe ? 'selected':'' }}>{{$pe}}</option>
                                          @endforeach
                                          </select>
                                          </div>
                                      </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          <label>Alamat Rumah</label>
                                          <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->alamat }}" name="alamat_wali" type="text" placeholder="eg. Off-White"  />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Alamat Kantor</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->alamat_kantor }}" name="alamat_kantor_wali" type="text" placeholder="no telepon"  />
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Rumah</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->nomor_telepon_rumah }}" name="nomor_telepon_rumah_wali" type="text" placeholder="no telepon"  />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Kantor</label>
                                            <input class="multisteps-form__input form-control" value="{{ $get->keluarga->wali->nomor_telepon_kantor }}" name="nomor_telepon_kantor_wali" type="text" placeholder="no telepon"  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
