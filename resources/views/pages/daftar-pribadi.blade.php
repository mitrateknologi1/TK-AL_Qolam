                                     ...
                                     <div class="row mt-3">
                                      ...
                                      <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input class="multisteps-form__input form-control" name="jumlah_penghuni_dewasa" type="number" placeholder="Jumlah orang dewasa di rumah"  required="required"/>
                                        </div>
                                      </div> 
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                            <label class="mt-2">Jumlah penghuni anak-anak di rumah</label>
                                            <input class="multisteps-form__input form-control" name="jumlah_penghuni_anak" type="number" placeholder="Jumlah anak di rumah"  required="required"/>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                       <div class="col-sm-6 mt-sm-0 mt-4">
                                        ...
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="selera_makan" type="text" placeholder="Selera makan anak"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="kebiasan_tidur_malam" type="text" placeholder="Contoh: jam 22.00"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6">
                                          <label>Kebiasaan bangun pagi pada umumnya pukul</label>
                                          <input class="multisteps-form__input form-control" name="kebiasan_bangun_pagi" type="text" placeholder="Contoh: jam 06.00"  required="required"/>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                          <label>Kebiasaan tidur siang pada umumnya pukul</label>
                                          <input class="multisteps-form__input form-control" name="kebiasan_tidur_siang" type="text" placeholder="Contoh: Jam 14.00"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="hal_penting_waktu_tidur" type="text" placeholder="Contoh: Harus pakai bantal"  required="required"/>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="hal_penting_tingkahlaku_anak" type="text" placeholder="Contoh: Suka memanjat"  required="required"/>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="sifat_baik" type="text" placeholder="Contoh: Suka Menolong"  required="required"/>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                          <label>Sifat buruk anak</label>
                                          <input class="multisteps-form__input form-control" name="sifat_buruk" type="text" placeholder="Contoh: Gampang Menangis"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
