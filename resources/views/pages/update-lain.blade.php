                ...
                <div class="row">
                    ...
                    <div class="multisteps-form">
                        ...
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" method="POST" action="{{ url('update-lain/'.$getidsurvei) }}">
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="kehadiran_dua_bulan" rows="5" cols="5" > {{ $get->survei->kehadiran_dua_bulan }} </textarea>
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="kontrol_pengembangan" rows="5" cols="5" > {{ $get->survei->kontrol_pengembangan }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="tatib_merokok" rows="5" cols="5" > {{ $get->survei->tatib_merokok }} </textarea>
                                        </div>  
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="kerja_sama" rows="5" cols="5" > {{ $get->survei->kerja_sama }} </textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                      <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="gizi_sehat" rows="5" cols="5" > {{ $get->survei->gizi_sehat }} </textarea>
                                      </div>  
