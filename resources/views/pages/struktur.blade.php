@extends('layouts.app')
@section('title', 'struktur TKTI AL-QOLAM')
@section('content')

<div class="breadcrum-area">
            <div class="container">
                    <h1 class="title h2">Struktur Tenaga Pendidik dan Kependidikan</h1>
            </div>
</div>
                        ...
                        <div class="blog-grid">
                            ...
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="assets/front-app/media/blog/bagan1.png" alt="">
                                </div>
                            </div>
                            <div class="post-thumbnail">
                                <div class="slick-slider slick-arrow-nav slick-dot-nav" data-slick='{"infinite": true, "autoplay": true, "arrows": true, "dots": true, "slidesToShow": 1}'>
                                    <div class="slick-slide">
                                        <a href="single-blog-gallery.html"><img src="assets/front-app/media/blog/.." alt=""></a>
                                    </div>
                                </div>
                            </div>
