                ...
                <div class="row">
                    ...
                    <div class="multisteps-form">
                        ...
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" method="POST" action="{{ url('update-peserta/'.$get->id) }}">
                                @csrf
                                @method('PUT')
                                  <!--single form panel-->
                                    ...
                                    <div class="multisteps-form__content">
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" value="{{$get->nama_lengkap}}" name="nama_peserta" type="text" placeholder="eg. Off-White"  required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Nama Panggilan</label>
                                          <input class="multisteps-form__input form-control" value="{{$get->nama_panggilan}}" name="nama_panggilan" type="text" placeholder="eg. Off-White" required  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <select class="form-control" name="jenis_kelamin" >
                                            ...
                                            <option value="{{$kat}}" {{ $get->jenis_kelamin == $kat ? 'selected':'' }}>{{$kat}}</option>
                                            @endforeach
                                        </select>
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Usia</label>
                                            <input class="multisteps-form__input form-control" value="{{$get->usia}}" name="usia_peserta" type="number" placeholder="eg. Off-White"  required/>
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Tempat Lahir</label>
                                            <input class="multisteps-form__input form-control" value="{{$get->tempat_lahir}}" name="tempat_lahir_peserta" type="text" placeholder="Palu"  required/>
                                          </div>
                                        <div class="col-12 col-sm-6">
                                            <label>Tanggal Lahir</label>
                                            <input class="multisteps-form__input form-control" value="{{$get->tanggal_lahir}}" name="tanggal_lahir_peserta" type="date" placeholder="7 Juli 2013"  required/>
                                          </div>
                                          <div class="col-12 col-sm-6">
                                            <label>Agama</label>
                                            <input class="multisteps-form__input form-control" disable value="{{$get->agama}}" name="agama_peserta" type="text" placeholder="Islam"   required/>
                                          </div>
                                      </div>
                                      </div>
                                      <div class="row mt-3">
                                       <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" value="{{$get->jumlah_saudara_kandung}}" name="jumlah_saudara_kandung" type="number" placeholder="eg. Off-White"  required/>
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label class="mt-2">Jumlah saudara tiri-</label>
                                            <input class="multisteps-form__input form-control" value="{{$get->jumlah_saudara_tiri}}" name="jumlah_saudara_tiri" type="number" placeholder="eg. Off-White"  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          <label>Sebutkan nama saudara yang dimiliki serta usianya</label>
                                          <textarea class="multisteps-form__input form-control"  name="nama_saudara_dan_usia" rows="5" cols="5" placeholder="eg. Off-White" required="required">{{$get->nama_saudara_dan_usia}}</textarea>
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Alamat Tempat Tinggal</label>
                                          <input class="multisteps-form__input form-control" value="{{$get->alamat}}" name="alamat" type="text" placeholder="eg. Off-White"  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                       <div class="col-12 col-sm-6">
                                          <label>berat badan (dalam kg)</label>
                                          <input class="multisteps-form__input form-control" value="{{$get->berat_badan}}" name="berat_badan" type="number" placeholder="eg. Off-White"  />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Tinggi Badan (dalam cm)</label>
                                          <input class="multisteps-form__input form-control" value="{{$get->tinggi_badan}}" name="tinggi_badan" type="number" placeholder="eg. Off-White"  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label class="mt-2">Anak ke </label>
                                            <input class="multisteps-form__input form-control" value="{{$get->urutan_lahir}}" name="urutan_lahir" type="number" placeholder="eg. Off-White"  />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label class="mt-2">Informasi Penting berkenaan dengan putra/i bpk/ibu</label>
                                            <textarea class="multisteps-form__input form-control" name="informasi" rows="5" cols="5" placeholder="kemampuan buang air secara mandiri, dan informasi lainnya" required="required"> {{$get->informasi}} </textarea>
                                        </div>
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <textarea class="multisteps-form__input form-control" rows="5" name="alergi" cols="5" placeholder="alergi makanan, bunga, atau debu" required="required">{{$get->alergi}}</textarea>
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label class="mt-2">Penyakit yang diderita</label>
                                            <textarea class="multisteps-form__input form-control" name="penyakit" rows="5" cols="5" placeholder="sebutkan perawatan dan pantangannya" required="required">{{$get->penyakit}}</textarea>
                                        </div>
                                      </div>
                                      <p></p>
                                            ...
                                            <div class="col-sm-6 mt-sm-0 mt-4">
                                                <label class="mt-2">Masuk TK ini sebagai</label>
                                                 <select class="form-control" name="kategori_peserta" id="kategori_peserta">
                                                    ...
                                                    @foreach($kategori as $kat)
                                                    <option value="{{$kat}}" {{ $get->kategori_peserta == $kat ? 'selected':'' }}>{{$kat}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-12 col-sm-6 mt-3 mt-sm-0" id="pindahan_fields">
                                                <label>Pindahan dari TK</label>
                                                <input class="multisteps-form__input form-control" value="{{ $get->pindahan_tk }}" name="pindahan_tk" type="text" placeholder="Tk Harapan" />
                                            </div>
                                        </div>
                                        <div class="row mt-3" >
                                            <div class="col-12 col-sm-6" id="pindahan_date_fields">
                                                <label>Tanggal Pindahan</label>
                                                <input class="multisteps-form__input form-control" value="{{ $get->tanggal_pindahan }}" name="tanggal_pindahan" type="date" placeholder="eg. Off-White" />
                                            </div>
                                            <div class="col-12 col-sm-6 mt-3 mt-sm-0" id="pindahan_date_terima_fields">
                                                <label>Tanggal diterima di TKIT AL-Qolam</label>
                                                <input class="multisteps-form__input form-control" value="{{ $get->tanggal_diterima }}"  name="tanggal_diterima" type="date" placeholder="Islam" />
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-6">
                                                <label>Dikelompok</label>
                                                <input class="multisteps-form__input form-control" value="{{ $get->kelompok }}" name="kelompok" type="text" placeholder="eg. Off-White" />
                                            </div>
                                        </div>
