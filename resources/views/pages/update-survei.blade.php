                ...
                <div class="row">
                    ...
                    <div class="multisteps-form">
                        ...
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" method="POST" action="{{ url('update-survei/'.$getsurvei) }}">
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="tidak_boleh_ditunggu" rows="5" cols="5" > {{$get->survei->tidak_boleh_ditunggu}} </textarea>
                                        </div>
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="larangan_berpakaian_perhiasan" rows="5" cols="5" > {{$get->survei->larangan_berpakaian_perhiasan}} </textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="berpakaian_islami" rows="5" cols="5" > {{$get->survei->berpakaian_islami}} </textarea>
                                    </div>
