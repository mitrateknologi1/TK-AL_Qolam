...
class landing extends Controller
{
    ...
    public function daftarkeluarga()
    {
        ...
        if (empty($peserta)) return redirect()->to('daftar-peserta');
    ...
    public function daftarlain()
    {
        ...
        if (empty($getsurvei)) return redirect()->to('daftar-survei');

        // Jika peserta dengan user_id yang sama sudah ada
        if (
            $getsurvei->kehadiran_dua_bulan != Null || $getsurvei->tatib_merokok != Null
